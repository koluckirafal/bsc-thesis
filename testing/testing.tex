...
Procesor VexRiscv został skonfigurowany z pamięcią podręczną danych wielkości XX kibibajtów oraz z obsługą architektury RV32xx - obecność pamięci podręcznej jest szczególnie ważna, gdyż to właśnie na jej potrzeby procesor zawiera wsparcie dla transferów potokowych na magistrali Wishbone.
...
\todo[inline]{schemat blokowy TestSoC}
